    ...
    return Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                ...
                Container(
                  child: Text("Sign In to Continue", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800),),
                ),
                ...
                Container(
                  child: Text("Forgot Password?", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w800),),
                ),
                ...
                Container(
                  child: GestureDetector(
                    ...
                    children: <TextSpan>[
                      TextSpan(text: "Don't have an account? | ", style: TextStyle(color: Colors.black, fontWeight: FontWeight.w900, fontSize: 15), ),
